   ...
   <div class="m-0">
      ...
      <div class="flex">
         ...
         <div class="content px-5 py-3 bg-[#F5F7FB] mt-0">
            ...
            <div class="rounded-md bg-white py-7 flex items-stretch mt-6 ">
               <a href="" class="text-gray-500 flex-1 text-center"><router-link :to="{ name: 'IndexLoan' }"> <i class="fa-solid fa-rectangle-list"></i> Loan </router-link></a>
               <a href="" class="text-gray-500 flex-1 text-center"><router-link :to="{ name: 'IndexBook' }"> <i class="fa fa-book"></i> Book </router-link></a>
               <a href="" class="text-gray-500 flex-1 text-center"><router-link :to="{ name: 'IndexUser' }"> <i class="fa fa-users"></i> Users </router-link></a>
            </div>

            <div class="rounded-md mt-5">               
               <div class="sm:grid grid-flow-col justify-stretch gap-5">
                  <div class="">
                     <div class="rounded-md bg-green-100 p-4 text-green-600 w-full staff">
                        <h2 class="font-bolder">Total Users</h2>
                     ...
                     <div class="rounded-md bg-white p-0 pt-2 mt-5 w-full staff">
                        <h2 class="font-bolder ml-4">Books Status</h2>
                  ...
                  <div class="rounded-md xs:mt-5 md:mt-0 bg-white pt-2">
                     <h2 class="ml-4">Loans status</h2>
